...
export function WhatsAppButton({ message }: { message?: string }) {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-xl shadow-black/40 transition-transform hover:scale-105 focus-visible:scale-105 sm:bottom-6 sm:right-6"
    >
